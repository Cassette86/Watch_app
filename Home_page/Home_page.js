          ...
          <View style={{flexDirection:'column',gap: 30}}>
              <View style={styles.row}>
                  ...
                  <View style={{paddingLeft : '55%'}}>
                      <Card Title='Galaxy Watch' Subtitle='Series 4' Price='$599' Color={'#FFEFE1'}
                      onPress={() => CardPress('Galaxy Watch Series 4','$599')}/>
                  </View>
              </View>
              <View style={styles.row}>
                  <Card Title='Mi Watch' Subtitle='All Series' Price='$299' Color={'#F0DEC5'}
                  onPress={() => CardPress('Mi Watch All Series','$299')}/>
                  <View style={{paddingLeft : '55%'}}>
                  <Card Title='Amazfit Bip U' Subtitle='Pro Series' Price='$199' Color={'#FCF1F0'}
